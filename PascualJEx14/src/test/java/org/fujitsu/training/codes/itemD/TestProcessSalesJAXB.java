...
public class TestProcessSalesJAXB {
	private ProcessSalesJAXB pjb;

	@BeforeEach
	public void setup() {
		pjb = new ProcessSalesJAXB();
	}
	...
	@Test
	public void testCreateSalesEmployeesXML() {
		String filename = "./src/main/resources/files/sales.xml";
		...
		pjb.createEmployeesXML(filename, salesEmps);
	}

	@Test
	public void testParseSalesXML() {
		String filename = "./src/main/resources/files/sales.xml";

		pjb.parseSalesXML(filename);
	}
}
