...
\restrict QFPaBho6spfq13FQvi99P3nQbV3sufW4fkRiSPPPQ8vwU4PMYf6KXGJw7EuZJSM
...
68736	ANDRES	CLERK	67858	1997-05-23	1200.00	\N	2001
...
--
-- Name: employees employees_dep_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employees
    ADD CONSTRAINT employees_dep_id_fkey FOREIGN KEY (dep_id) REFERENCES public.department(dep_id);
...
\unrestrict QFPaBho6spfq13FQvi99P3nQbV3sufW4fkRiSPPPQ8vwU4PMYf6KXGJw7EuZJSM
